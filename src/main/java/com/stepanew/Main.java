...
import com.stepanew.filters.GrayScale;
import com.stepanew.filters.Histogram;
import com.stepanew.filters.KMeansOnColor;
import com.stepanew.filters.PeaksDetector;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        BufferedImage image = fileReader.ReadImage(SECOND_SAMPLE + "." + PNG);
        ...
        KMeansOnColor kMeanClustering = new KMeansOnColor(image, peaks.size(), ITERATIONS, peaks);
